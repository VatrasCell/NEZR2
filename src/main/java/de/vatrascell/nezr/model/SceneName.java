...
public class SceneName {
    ...
    public static final String LOGIN_PATH = "/view/LoginView.fxml";
    public static final String LANDING_PATH = "/view/LandingView.fxml";
    public static final String ADMIN_PATH = "/view/AdminView.fxml";
    public static final String QUESTION_LIST_PATH = "/view/QuestionListView.fxml";
