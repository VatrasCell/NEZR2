...
-- Table `flag_list`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `flag_list` ;

CREATE TABLE IF NOT EXISTS `flag_list` (
  `flag_list_id` INT NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`flag_list_id`),
  INDEX `fk_flag_list_validation1_idx` (`validation_id` ASC),
  CONSTRAINT `fk_flag_list_validation1`
...
CREATE TABLE IF NOT EXISTS `q_has_mc` (
  ...
  INDEX `fk_q_has_mc_flag_list1_idx` (`flag_list_id` ASC),
  ...
  CONSTRAINT `fk_MultipleChoice_has_Fragebogen_Fragebogen1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_q_has_mc_flag_list1`
    FOREIGN KEY (`flag_list_id`)
    REFERENCES `flag_list` (`flag_list_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `q_has_sa` (
  ...
  INDEX `fk_q_has_sa_flagList1_idx` (`flag_list_id` ASC),
  ...
  CONSTRAINT `fk_FreieFragen_has_Fragebogen_Fragebogen1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_q_has_sa_flagList1`
    FOREIGN KEY (`flag_list_id`)
    REFERENCES `flag_list` (`flag_list_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- Table `q_has_react`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `q_has_react` ;

CREATE TABLE IF NOT EXISTS `q_has_react` (
  `q_has_react_id` INT NOT NULL AUTO_INCREMENT,
  `q_has_sa_id` INT NULL,
  `q_has_mc_id` INT NULL,
  ...
  INDEX `fk_q_has_react_q_has_mc1_idx` (`q_has_mc_id` ASC),
  ...
  CONSTRAINT `fk_q_has_react_react1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_q_has_react_q_has_mc1`
