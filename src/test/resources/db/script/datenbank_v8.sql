...
(
    ...
    INDEX `fk_MultipleChoice_Kategorie1`
(
    `category_id` ASC
),
    INDEX `fk_multiple_choice_headline1_idx`
(
    `headline_id` ASC
),
...
(
    ...
    INDEX `fk_MultipleChoice_has_Fragebogen_MultipleChoice`
(
    `multiple_choice_id` ASC
),
    INDEX `fk_MultipleChoice_has_Fragebogen_Fragebogen1`
(
...
(
    ...
    INDEX `fk_FreieFragen_Kategorie1`
(
    `category_id` ASC
),
    INDEX `fk_FreieFragen_headline1_idx`
(
    `headline_headline_id` ASC
),
...
(
    ...
    INDEX `fk_FreieFragen_has_Fragebogen_FreieFragen1`
(
    `short_answer_id` ASC
),
    INDEX `fk_FreieFragen_has_Fragebogen_Fragebogen1`
(
    `questionnaire_id` ASC
),
    INDEX `fk_q_has_sa_validation1_idx`
(
    `validation_id` ASC
),
...
(
    ...
    INDEX `fk_Befragung_Fragebogen1`
(
    `questionnaire_id` ASC
),
...
(
    ...
    INDEX `fk_Befragung_has_MultipleChoice_Befragung1`
(
    `survey_id` ASC
),
    INDEX `fk_Befragung_has_MultipleChoice_MultipleChoice1`
(
    `multiple_choice_id` ASC
),
...
(
    ...
    INDEX `fk_Befragung_has_FreieFragen_Befragung1`
(
    `survey_id` ASC
),
    INDEX `fk_Befragung_has_FreieFragen_FreieFragen1`
(
    `short_answer_id` ASC
),
...
(
    ...
    INDEX `fk_react_short_answer1_idx`
(
    `short_answer_id` ASC
),
    INDEX `fk_react_multiple_choice1_idx`
(
    `multiple_choice_id` ASC
),
...
(
    ...
    INDEX `fk_q_has_react_q_has_sa1_idx`
(
    `q_has_sa_id` ASC
),
    INDEX `fk_q_has_react_react1_idx`
(
    `react_id` ASC
),
...
(
    ...
    INDEX `fk_mc_has_react_react1_idx`
(
    `react_id` ASC
),
    INDEX `fk_mc_has_react_q_has_mc1_idx`
(
    `q_has_mc_id` ASC
),
...
-- Table `mc_has_ao`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mc_has_ao`;

CREATE TABLE IF NOT EXISTS `mc_has_ao`
(
    `mc_has_ao_id`
    INT
    NOT
...
(
    ...
    INDEX `fk_mc_has_ao_multiple_choice1_idx`
(
    `multiple_choice_id` ASC
),
    INDEX `fk_mc_has_ao_answer_option1_idx`
(
    `answer_option_id` ASC
),
    CONSTRAINT `fk_mc_has_ao_multiple_choice1`
    FOREIGN KEY
(
    `multiple_choice_id`
)
...
(
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
    CONSTRAINT `fk_mc_has_ao_answer_option1`
    FOREIGN KEY
(
    `answer_option_id`
)
...
-- Table `s_has_ao`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `s_has_ao`;

CREATE TABLE IF NOT EXISTS `s_has_ao`
(
    `s_has_ao_id`
    INT
    NOT
...
(
    ...
    INDEX `fk_s_has_ao_answer_option1_idx`
(
    `answer_option_id` ASC
),
    INDEX `fk_s_has_ao_s_has_mc1_idx`
(
    `s_has_mc_id` ASC
),
    CONSTRAINT `fk_s_has_ao_answer_option1`
    FOREIGN KEY
(
    `answer_option_id`
)
...
(
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
    CONSTRAINT `fk_s_has_ao_s_has_mc1`
    FOREIGN KEY
(
    `s_has_mc_id`
)
