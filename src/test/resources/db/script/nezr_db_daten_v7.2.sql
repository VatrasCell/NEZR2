...
(NULL, 1, 1, 1), (NULL, 1, 2, 2), (NULL, 1, 3, 3), (NULL, 1, 4, 3), (NULL, 1, 5, 4), 
(NULL, 1, 6, 6), (NULL, 1, 7, 7), (NULL, 1, 8, 8), (NULL, 1, 9, 9), (NULL, 1, 10, 10), 
(NULL, 1, 11, 11), (NULL, 1, 12, 12), (NULL, 1, 13, 12), (NULL, 1, 14, 12), (NULL, 1, 15, 12), 
(NULL, 1, 16, 12), (NULL, 1, 17, 12), (NULL, 1, 18, 12), (NULL, 1, 19, 12), (NULL, 1, 20, 12), 
(NULL, 1, 21, 12), (NULL, 1, 22, 12), (NULL, 1, 23, 12), (NULL, 1, 24, 12), (NULL, 1, 25, 13), 
(NULL, 1, 26, 13), (NULL, 1, 27, 10), (NULL, 1, 28, 11);

INSERT INTO q_has_sa VALUES
(NULL, 1, 1, 4, NULL), (NULL, 1, 2, 5, NULL), (NULL, 1, 3, 5, 1), (NULL, 1, 4, 8, NULL), (NULL, 1, 5, 9, 2),
(NULL, 1, 6, 14, NULL);

INSERT INTO flag_list_mc VALUES
-- id B      +      *     LIST   JN      X 
...
INSERT INTO flag_list_sa VALUES
-- id +     TEXT 
(1, FALSE, FALSE),
(2, FALSE, FALSE),
(3, FALSE, FALSE),
...
INSERT INTO sa_has_react VALUES
(NULL, 1, 3),
(NULL, 2, 4),
(NULL, 3, 5),
(NULL, 5, 1);

INSERT INTO mc_has_react VALUES
(NULL, 1, 27),
(NULL, 2, 28);
